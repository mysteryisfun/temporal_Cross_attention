#!/usr/bin/env python3
"""
Dynamic Feature Extraction Script - Part 1
Processes the first half of the dataset (e.g., first 40,000 samples).
"""
...
def main():
    """Main execution function for Part 1 (first half of the dataset)"""
    print("🌊 Starting GPU-Accelerated Dynamic Feature Extraction - Part 1")
    print("=" * 70)
    ...
    # Process only the first 40,000 samples
    optical_flow_paths = optical_flow_paths[:40000]
    print(f"Processing first 40,000 samples\n")
    ...
    try:
        ...
        features_path = output_dir / "dynamic_features_part1.npy"
        ...
        log_path = output_dir / "dynamic_feature_extraction_part1_log.json"
        with open(log_path, 'w') as f:
            json.dump(extraction_stats, f, indent=2, default=str)
        print(f"\n🎉 Dynamic Feature Extraction Part 1 Completed Successfully!")
        ...
        log_path = output_dir / "dynamic_feature_extraction_part1_error_log.json"
        with open(log_path, 'w') as f:
            json.dump(extraction_stats, f, indent=2, default=str)
        raise
